...
/// <inheritdoc />
public partial class Postgres_20260421_1639 : Migration
{
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Username = table.Column<string>(type: "character varying(15)", unicode: false, maxLength: 15, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                Id = table.Column<int>(type: "integer", nullable: false)
                    .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                Token = table.Column<string>(type: "character(26)", fixedLength: true, maxLength: 26, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                EditedById = table.Column<int>(type: "integer", nullable: false)
            },
            constraints: table =>
            {
